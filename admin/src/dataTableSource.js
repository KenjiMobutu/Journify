export const userColumns = [
  ...
  },
  {
    ...
    align: 'center',
    renderCell: (params) => {
      const hasBookings = params.row.bookings.length > 0 || params.row.flightBookings.length > 0 || params.row.taxiBookings.length > 0;
    ...
    renderCell: (params) => {
      ...
      return (
        <div className="cellWithImg">
          <img
            className="cellImg"
            src={params.row.img || "https://e7.pngegg.com/pngimages/84/165/png-clipart-united-states-avatar-organization-information-user-avatar-service-computer-wallpaper-thumbnail.png"}
            alt="img"
          />
          {params.row.userName}
        </div>
...
export const hotelColumns = [
  { field: "_id", headerName: "ID", width: 250, headerAlign: 'center',  // Centrer le titre
    align: 'center',},
  {
    field: "name",
    headerName: "Name",
